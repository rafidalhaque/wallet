...
class LoanSupabaseDataSource @Inject constructor(
    ...
    suspend fun save(entity: LoanEntity) {
        try {
            ...
            throw SupabaseDataException("Failed to save loan: ${e.message}", e)
        }
    }
    ...
    suspend fun saveMany(entities: List<LoanEntity>) {
        try {
            ...
            throw SupabaseDataException("Failed to save loans: ${e.message}", e)
        }
    }
    ...
    suspend fun deleteById(id: UUID) {
        try {
            ...
            throw SupabaseDataException("Failed to delete loan: ${e.message}", e)
        }
    }
    ...
    suspend fun deleteAll() {
        try {
            ...
            throw SupabaseDataException("Failed to delete all loans: ${e.message}", e)
        }
    }
}
